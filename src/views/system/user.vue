  ...
  <div>
    <basic-container>
      <avue-crud :option="option" :table-loading="loading" :data="data" ref="crud" v-model="form"
        ...
        :before-open="beforeOpen" :page="page" @search-change="searchChange" @search-reset="searchReset"
        ...
        <template slot="menuLeft">
          ...
          <top-crud :list='list' @handleDelete="handleDelete"></top-crud>
        </template>
        <template slot-scope="{row}" slot="menu">
          <operation-crud :row="row"></operation-crud>
        </template>
...
<script>
  ...
  import topCrud from '@/components/crud/top-crud'
  import operationCrud from '@/components/crud/operation-crud'
