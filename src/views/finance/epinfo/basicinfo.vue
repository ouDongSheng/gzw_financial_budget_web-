...
<el-container>
  <el-aside width="160px">
    <img src='../../../images/企业树2.png'/>
  </el-aside>
  <el-main>
     <div style='padding-top:6px;margin-left:-16px;padding-left:16px;height:46px;width:99%;background:#fafbfc;align:right'>
       <template>
         <el-tabs type="border-card">
          <el-tab-pane label="企业概况">
            <div style='background:white;margin-top:0px;padding:6px;align:center;height:420px;width:100%'>
	     
	      <img src='../../../images/1_1公司信息-企业概况.png'/>
	    
            </div>
          </el-tab-pane>
          <el-tab-pane label="基本信息">
            <div style='background:white;margin-top:0px;padding:6px;align:center;height:420px;width:100%'>
	      <img src='../../../images/1_2公司信息-基本信息.png'/>
            </div>
	  </el-tab-pane>
          <el-tab-pane label="工商信息">
            <div style='background:white;margin-top:0px;padding:6px;align:center;height:420px;width:100%'>
	      <img src='../../../images/1_3公司信息-工商信息.png'/>
            </div>
	  </el-tab-pane>
          <el-tab-pane label="高管信息">
            <div style='background:white;margin-top:0px;padding:6px;align:center;height:420px;width:100%'>
	      <img src='../../../images/1_4公司信息-高管信息.png'/>
            </div>
	  </el-tab-pane>
	  <el-tab-pane label="股东结构">
            <div style='background:white;margin-top:0px;padding:6px;align:center;height:420px;width:100%'>
	      <img src='../../../images/1_5公司信息-股东结构.png'/>
            </div>
	  </el-tab-pane>
         </el-tabs>
       </template>
