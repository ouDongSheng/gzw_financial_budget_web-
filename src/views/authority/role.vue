  ...
  <basic-container>
    <avue-crud :option="option"
      ...
      <template slot-scope="{row}" slot="menu">
        <!-- <el-button icon="el-icon-check" size="small" type="text"  @click="handleEdit(row, row.$index)">编辑</el-button> -->
      </template>
    </avue-crud>
  ...
  export default {
    ...
    methods: {
      ...
      onLoad(page, params = {}) {
        ...
        getList(page.currentPage, page.pageSize, Object.assign(params, this.query)).then(res => {
          ...
          getRoleTree().then(res => {
            ...
            this.option.column[3].dicData = data;
          });
          this.loading = false;
          this.selectionClear();
        }).catch(() => {
      ...
      handleEdit(row ,index) {
        // getRoleTree(row.tenantId).then(res => {
        //     const data = res.data.data;
