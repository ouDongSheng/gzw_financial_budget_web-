  ...
  <el-table
	...
	<div fieldType='3' field='name'>日期</div>
     ...
     <el-table-column label="第一行1" header-align="center" align="center">
      <template slot-scope="scope"><div :fieldType="scope.row.date1.fieldType" :value="scope.row.date1.value" :align="scope.row.date1.align">{{ scope.row.date1.value }}</div></template>

     </el-table-column>

     <el-table-column label="第一行2" header-align="center" align="center">
        <template slot-scope="scope"><div :fieldType="scope.row.date2.fieldType" :value="scope.row.date2.value" :align="scope.row.date2.align">{{ scope.row.date2.value }}</div></template>
	 ...
	 */
	 ...
	 for(var i=0;i<rows;i++)
	 {
	    ...
	    for(var j=2;j<cells;j++)
	    {
	       ...
	       if(value==null) value='';
	       if(height<40)  nodeObj.innerHTML="<input style='border:1px solid green;width:100%;height:"+height+"px'>"+value+"</div>";
	       else nodeObj.innerHTML="<div contenteditable='true' style='border:1px solid green;overflow:auto;width:100%;height:"+height+"px'>"+value+"</div>";
	    }
	 }
